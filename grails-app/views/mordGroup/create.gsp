...
<div class="row-fluid">
    <div class="col-xs-12">
        <div>
            <h1><g:message
                    code="group.create"/> <small><g:message code="group.create.hint"/></small>
            </h1>
            <hr/>
        </div>
...
<div class="col-xs-12">
    ...
    <g:form url="[resource: mordGroupInstance, action: 'save']" class="form-horizontal" data-toggle="validator">
