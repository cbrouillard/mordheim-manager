...
<div class="row-fluid">
    <div class="col-sm-12">
        ...
        <div>
            ...
            <h1>
                <g:message
                        code="wrench.changephoto"/> <small>${wrenchmenInstance.name}</small>
...
<div class="col-xs-12">
    ...
    <g:uploadForm action="savephoto" class="form-horizontal" controller="wrenchmen"><g:hiddenField name="id" value="${wrenchmenInstance.id}"/>
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <div class="thumbnail form-control-static">
                                    <g:if test="${!wrenchmenInstance.photo}">
                                        <asset:image src="Mordheim.gif" class="imgband"/>
                                    </g:if>
                                    <g:else>
                                        <img src="${createLink(action: 'photo', id: wrenchmenInstance.id, controller: 'wrenchmen')}"/>
                                    </g:else>
                                </div>
                            </div>
