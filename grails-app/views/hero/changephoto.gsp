...
<div class="row-fluid">
    <div class="col-sm-12">
        ...
        <div>
            ...
            <h1>
                <g:message
                        code="hero.changephoto"/> <small>${heroInstance.name}</small>
...
<div class="col-xs-12">
    ...
    <g:uploadForm action="savephoto" class="form-horizontal" controller="hero"><g:hiddenField name="id" value="${heroInstance.id}"/>
