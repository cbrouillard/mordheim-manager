...
<div class="row-fluid">
    <div class="col-xs-12">
        <div>
            <h1><g:message
                    code="hero.edit"/> <small><g:message code="hero.edit.hint"/></small>
            </h1>
            <hr/>
        </div>
...
<div class="col-xs-12">
    ...
    <g:form url="[resource: heroInstance, action: 'update']" class="form-horizontal" data-toggle="validator" method="PUT">
            ...
            <div class="panel-footer">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <g:link class="btn btn-default" controller="band" action="show" id="${heroInstance?.band.id}">
