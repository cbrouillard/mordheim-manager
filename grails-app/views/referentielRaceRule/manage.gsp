            ...
            <table class="table">
                <g:each in="${race.specialRules.sort({ it.name })}" var="rule">
                    <tr>
                        ...
                        <td class="text-right">
                            <div class="btn-group">
                                <g:link controller="referentielRaceRule" action="delete" class="btn btn-danger btn-xs"
                                        id="${rule.id}" params="[race:race.id]">
                                    <span class="glyphicon glyphicon-remove"></span>
                                </g:link>
                                <g:link controller="referentielRaceRule" action="edit" class="btn btn-success btn-xs"
                                        id="${rule.id}" params="[race:race.id]">
...
<div class="col-sm-9 col-xs-12">
    <g:form url="[controller: 'referentielRaceRule', action: toAction]" class="form-horizontal" data-toggle="validator">
