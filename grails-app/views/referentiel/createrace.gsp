...
<div class="row-fluid">
    <div class="col-xs-12">
        <div>
            <h1><g:message
                    code="referentiel.race.create"/> <small><g:message code="referentiel.race.create.hint"/></small>
            </h1>
            <hr/>
        </div>
...
<div class="col-xs-12">
    ...
    <g:form url="[controller:'referentiel', action: 'saverace']" class="form-horizontal" data-toggle="validator">
