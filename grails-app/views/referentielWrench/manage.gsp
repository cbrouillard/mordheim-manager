            ...
            <table class="table">
                <g:each in="${race.wrenches.sort({ it.type })}" var="wrench">
                    <tr>
                        ...
                        <td class="text-right">
                            <div class="btn-group">
                                <g:link controller="referentielWrench" action="delete" class="btn btn-danger btn-xs"
                                        id="${wrench.id}">
                                    <span class="glyphicon glyphicon-remove"></span>
                                </g:link>
                                <g:link controller="referentielWrench" action="edit" class="btn btn-success btn-xs"
                                        id="${wrench.id}">
...
<div class="col-sm-9 col-xs-12">
    <g:form url="[controller: 'referentielWrench', action: toAction]" class="form-horizontal" data-toggle="validator">
