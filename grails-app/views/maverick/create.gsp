...
<div class="row-fluid">
    <div class="col-xs-12">
        <div>
            <h1><g:message
                    code="maverick.create"/> <small><g:message code="maverick.create.hint"/></small>
            </h1>
            <hr/>
        </div>
...
<div class="col-xs-12">
    ...
    <g:form url="[resource: maverickInstance, action: 'save']" class="form-horizontal" data-toggle="validator">
