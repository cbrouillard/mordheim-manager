...
<div class="row-fluid">
    <div class="col-sm-12">
        ...
        <div>
            ...
            <h1>
                <g:message
                        code="maverick.changephoto"/> <small>${maverickInstance.name}</small>
...
<div class="col-xs-12">
    ...
    <g:uploadForm action="savephoto" class="form-horizontal" controller="maverick"><g:hiddenField name="id" value="${maverickInstance.id}"/>
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <div class="thumbnail form-control-static">
                                    <g:if test="${!maverickInstance.photo}">
                                        <asset:image src="Mordheim.gif" class="imgband"/>
                                    </g:if>
                                    <g:else>
                                        <img src="${createLink(action: 'photo', id: maverickInstance.id, controller: 'maverick')}"/>
                                    </g:else>
                                </div>
                            </div>
