...
<g:while test="${nb < 6}">
    ...
    <div class="pos" id="159:983" style="top:${top + 147};left:${left + 220}">
        <span id="9.8" style=" font-family:Arial; font-size:14px; color:#892a1a24">
            <g:message code="warband.warrior.experience.hero"
                       args="[hero?.fullXp != null ? hero.fullXp : '__']"/></span>
    </div>
...
<g:if test="${band.mavericks}">
    ...
    <g:while test="${nb < 6}">
        ...
        <div class="pos" id="159:983" style="top:${top + 150};left:${left + 190}">
            <span id="9.8" style=" font-family:Arial; font-size:14px; color:#892a1a24">
                <g:message code="warband.warrior.experience.maverick"
                           args="[maverick?.fullXp != null ? maverick.fullXp : '__']"/></span>
        </div>

        <div class="pos" id="159:983" style="top:${top + 170};left:${left + 190}">
            <span id="9.8" style=" font-family:Arial; font-size:14px; color:#892a1a24">
                <g:message code="warband.warrior.retenue.maverick"
                           args="[maverick?.retenueCost != null ? maverick.retenueCost : '__']"/></span>
        </div>
